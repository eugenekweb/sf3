...
class ExcelGenerator:
    ...
    def create_sheet(self, name: str, headers: List[str]) -> openpyxl.worksheet.worksheet.Worksheet:
        """Создание листа"""
    ...
    def add_participants_sheet(self, participants: List[Dict], chat_name: str = "Unknown"):
    ...
    def generate_text_list(self, participants: List[Dict], mentions: List[Dict], 
